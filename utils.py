...
# -- AI Instructions (CLoud as default) ----------------------------------------
def ask_groq(user_message):
    try:
        response = groq_client.chat.completions.create(
            model=MODEL,
            messages=[
                {"role": "system", "content": "You are Aether, Affan's cloud AI assistant."
                " You are the powerful twin of Terra who runs locally."
...
def ask_local(user_message):
    try:
        response = requests.post(
            ...
            json={
                "model": os.getenv("OLLAMA_MODEL", "paideia"),
